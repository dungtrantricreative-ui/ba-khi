...
- [x] Ghi nhận Vercel production là mục tiêu triển khai của Simpapa trong tài liệu và checklist deploy.
...
- [x] Đổi toàn bộ nhận diện sản phẩm hiển thị, title/metadata và tài liệu sang Simpapa; giữ nguyên metadata title phim.
...
- [x] Kiểm tra project Vercel đã kết nối, domain/deployment gần nhất và cấu hình build phù hợp với Simpapa.
- [ ] Khi project Simpapa được tạo/import trên Vercel, đối chiếu trực tiếp Environment Variables thực tế với checklist đã bàn giao.
