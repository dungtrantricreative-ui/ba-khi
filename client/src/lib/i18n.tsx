...
const VI: Dict = {
  ...
  "wordmark.aria": "Simpapa, trang chủ",
  "pill.public": "Catalog công khai",
  "lang.toggleTitle": "Đổi ngôn ngữ / Switch language",
  "settings.openAria": "Mở cài đặt",
  "settings.eyebrow": "Tùy chỉnh trải nghiệm",
  "settings.h1": "Cài đặt chung",
  "settings.intro": "Chọn cách Simpapa hiển thị và phản hồi trên thiết bị của bạn.",
  "settings.languageH2": "Ngôn ngữ",
  "settings.languageBody": "Ngôn ngữ này được lưu trên thiết bị hiện tại của bạn.",
  ...
  "note.tmdb": "Metadata đồng bộ trực tiếp từ TMDB. Nội dung phát qua hệ thống đa server với 4 nguồn dự phòng.",
  ...
  "player.via": "Nếu phim bị lỗi, hãy đổi server bên dưới. Nội dung được cung cấp bởi nguồn phát bên thứ ba.",
  "player.errorSwitch": "Server {n} không phản hồi — đã tự chuyển sang Server {m}",
  "player.timeout": "Server {n} tải chậm bất thường. Bạn có thể đổi server chỉ với 1 chạm.",
  "player.allFailed": "Tất cả server đều gặp sự cố. Hãy thử lại sau hoặc chọn phim khác.",
  "player.switchAction": "Đổi server",
  ...
  "credits.h1": "Credits & cách Simpapa vận hành",
  "credits.intro": "Simpapa là PoC xem phim công khai, không chạy quảng cáo, pop-up hoặc auto-preview. TMDB chỉ được dùng để lấy metadata cần thiết ở backend; video phát qua hệ thống đa server iFrame theo TMDB ID.",
  "credits.tmdbH2": "TMDB attribution",
  "credits.visitTmdb": "Truy cập The Movie Database",
  "credits.policyH2": "Playback policy",
  "credits.policyBody": "Trình phát hỗ trợ 4 server embed dự phòng được dựng URL tự động từ TMDB ID; người dùng có thể đổi server hoặc tập ngay trong trang xem mà không cần tải lại trang. Vercel Functions không được dùng làm relay video dài hạn.",
  ...
  "credits.adsBody": "Mọi quảng cáo, banner hoặc pop-up (nếu xuất hiện khi xem) đến từ nguồn phát bên thứ ba. Simpapa không chèn, không kiếm tiền từ và không kiểm soát được nội dung quảng cáo đó.",
...
const EN: Dict = {
  ...
  "wordmark.aria": "Simpapa, home",
  "pill.public": "Public catalog",
  "lang.toggleTitle": "Switch language / Đổi ngôn ngữ",
  "settings.openAria": "Open settings",
  "settings.eyebrow": "Personalize your experience",
  "settings.h1": "General settings",
  "settings.intro": "Choose how Simpapa looks and responds on your device.",
  "settings.languageH2": "Language",
  "settings.languageBody": "This preference is saved on your current device.",
  "settings.vietnamese": "Tiếng Việt",
  "settings.english": "English",
  ...
  "player.via": "If playback fails, switch servers below. Content is provided by a third-party source.",
  "player.errorSwitch": "Server {n} is not responding — switched to Server {m}",
  "player.timeout": "Server {n} is loading unusually slowly. You can switch servers with one tap.",
  "player.allFailed": "All servers failed. Try again later or pick another title.",
  "player.switchAction": "Switch server",
  ...
  "credits.h1": "Credits & how Simpapa operates",
  "credits.intro": "Simpapa is a public streaming PoC with no ads, pop-ups or auto-previews. TMDB is only used for required metadata on the backend; video plays through a multi-server iFrame system keyed by TMDB ID.",
  "credits.tmdbH2": "TMDB attribution",
  "credits.visitTmdb": "Visit The Movie Database",
  "credits.policyH2": "Playback policy",
  "credits.policyBody": "The player supports 4 fallback embed servers with URLs built automatically from the TMDB ID; you can swap servers or episodes inside the watch page without reloading. Vercel Functions are not used as a long-term video relay.",
  "credits.privacyH2": "Privacy",
