...
const VI: Dict = {
  ...
  "player.via": "Đang phát qua {server}. Pop-up, quảng cáo bật lên và chuyển hướng trang đã bị chặn bởi sandbox. Nếu phim bị lỗi, hãy đổi server bên dưới.",
...
const EN: Dict = {
  ...
  "player.via": "Playing via {server}. Pop-ups, ad windows and page redirects are blocked by the sandbox. If playback fails, switch servers below.",
