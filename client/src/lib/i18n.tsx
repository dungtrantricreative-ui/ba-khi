...
const VI: Dict = {
  ...
  "player.via": "Đang phát qua {server}. Nếu phim bị lỗi, hãy đổi server bên dưới. Quảng cáo pop-up (nếu có) do server bên thứ ba chèn vào, không phải từ Dũng Cảm.",
  "shield.hint": "Chạm lần 1 để kích hoạt khiên chặn quảng cáo · lần 2 để phát",
  "shield.armed": "Khiên chống pop-up đã bật",
...
const EN: Dict = {
  ...
  "player.via": "Playing via {server}. If playback fails, switch servers below. Any pop-up ads (if any) come from the third-party source — not from Dũng Cảm.",
  "shield.hint": "First tap arms the ad shield · second tap plays",
  "shield.armed": "Pop-up shield is on",
