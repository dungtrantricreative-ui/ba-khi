...
const VI: Dict = {
  ...
  "player.via": "Đang phát qua {server}. Nếu phim bị lỗi, hãy đổi server bên dưới. Nội dung trong iframe do server bên thứ ba cung cấp.",
  ...
  "credits.adsBody": "Mọi quảng cáo, banner hoặc pop-up (nếu xuất hiện khi xem) đến hoàn toàn từ các server nhúng bên thứ ba (VidLink, VidSrc, 2Embed, AutoEmbed) — nơi lưu trữ và phân phối nguồn phát. Simpapa không chèn, không kiếm tiền từ và không kiểm soát được nội dung quảng cáo đó. Chúng tôi không hợp tác với bất kỳ đơn vị quảng cáo nào.",
...
const EN: Dict = {
  ...
  "player.via": "Playing via {server}. If playback fails, switch servers below. Content inside the iframe is provided by the third-party source.",
