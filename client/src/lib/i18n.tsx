...
const VI: Dict = {
  ...
  "wordmark.aria": "Bá Khí, trang chủ",
  ...
  "credits.h1": "Credits & cách Bá Khí vận hành",
  "credits.intro": "Bá Khí là PoC xem phim công khai, không chạy quảng cáo, pop-up hoặc auto-preview. TMDB chỉ được dùng để lấy metadata cần thiết ở backend; video phát qua hệ thống đa server iFrame theo TMDB ID.",
  ...
  "credits.adsBody": "Mọi quảng cáo, banner hoặc pop-up (nếu xuất hiện khi xem) đến hoàn toàn từ các server nhúng bên thứ ba (VidLink, VidSrc, 2Embed, AutoEmbed) — nơi lưu trữ và phân phối nguồn phát. Bá Khí không chèn, không kiếm tiền từ và không kiểm soát được nội dung quảng cáo đó. Chúng tôi không hợp tác với bất kỳ đơn vị quảng cáo nào.",
...
const EN: Dict = {
  ...
  "credits.h1": "Credits & how Bá Khí operates",
  "credits.intro": "Bá Khí is a public streaming PoC with no ads, pop-ups or auto-previews. TMDB is only used for required metadata on the backend; video plays through a multi-server iFrame system keyed by TMDB ID.",
  "credits.tmdbH2": "TMDB attribution",
